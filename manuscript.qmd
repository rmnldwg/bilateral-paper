...
For example, we may assess contralateral LNL II involvement prevalence under early T-category (T0-T2) and no midline extension ($\epsilon=\texttt{False}$). In the data, {{< var data.early_lateral_cII_total >}} such patients were observed, with {{< var data.early_lateral_cII_match >}} exhibiting contralateral LNL II involvement -- a prevalence of {{< var data.early_lateral_cII_percent >}}%.
