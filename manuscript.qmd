...
Future work may also investigate if the different tumor subsites that make up all oropharyngeal SCC patients exhibit spread patterns that are substantially different. In turn, the model could benefit from more fine-grained information about the precise tumor subsite for its prediction.
