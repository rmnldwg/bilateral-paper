...
\caption{}\label{T_20ee3}\tabularnewline
\toprule\noalign{}
...
no ipsilateral nodal involvement (levels I-V), only 1.2\% (1 of 86
patients) show involvement in contralateral level II. This proportion
increases to 8.8\% (24 of 272) if ipsilateral level II is involved, to
15.7\% (14 of 89) if ipsilateral levels II and III are involved, and
further to 22.2\% (12 of 54) for advanced T-category tumors with
...
\caption{}\label{T_651fd}\tabularnewline
\toprule\noalign{}
...
\item
  ...
  rises to 11.3\% (purple histogram).
\end{itemize}
...
neck predicts a risk of 7.6\%, compared to 9.1\% when LNLs II and III
are involved.
...
extreme cases, the risk increases to 5.5\%.
...
\caption{}\label{T_9c098}\tabularnewline
\toprule\noalign{}
